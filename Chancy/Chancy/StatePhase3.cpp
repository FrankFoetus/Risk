...
void StatePhase3::processInput(float* cameraSpeed, float* scaleSpeed, GameState& gameState) {
...
void StatePhase3::drawGame() {
	...
	*/
	...
	drawHud("Phase 3: Buy cards!", glm::vec2(-750, 360), glm::vec2(2), Bengine::ColorRGBA8(255, 255, 255, 255));
